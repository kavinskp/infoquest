...
def infoquest_total_students_entry(request):
    ...
    return render(request, 'iq/view_total_students_infoquest.html', {
...
def infoquest_students_registered(request):
    ...
    return render(request, 'iq/view_registered_infoquest.html', {
        'list_of_students': list_of_students,
        'accommodation_boys': accommodation_boys,
        'accommodation_girls': accommodation_girls,
        'boys': boys,
...
def infoquest_students_unverified(request):
    ...
    return render(request, 'iq/view_unverified_infoquest.html', {
        'list_of_students': list_of_students,
        'accommodation_boys': accommodation_boys,
        'accommodation_girls': accommodation_girls,
        'boys': boys,
...
def infoquest_on_spot(request):
    ...
    return render(request, 'iq/on_spot_infoquest.html', {
        'list_of_students': list_of_students,
        'accommodation_boys': accommodation_boys,
        'accommodation_girls': accommodation_girls,
        'boys': boys,
...
def infoquest_boys_accommodation(request):
    ...
    return render(request, 'iq/boys_accommodation.html', {
        'list_of_students': list_of_students
    })
...
def infoquest_girls_accommodation(request):
    ...
    return render(request, 'iq/girls_accommodation.html', {
        'list_of_students': list_of_students
    })
...
class infoquest_TotalStudentsPDF(PDFTemplateView):
    template_name = "iq/total_students_infoquest_pdf.html"
...
class infoquest_RegisteredPDF(PDFTemplateView):
    template_name = "iq/registered_infoquest_pdf.html"
...
class infoquest_UnVerifiedPDF(PDFTemplateView):
    template_name = "iq/unverified_infoquest_pdf.html"
...
class infoquest_OnspotPDF(PDFTemplateView):
    template_name = "iq/onspot_infoquest_pdf.html"
...
class infoquest_boys_PDF(PDFTemplateView):
    template_name = "iq/boys_accommodation_infoquest.html"
...
class infoquest_girls_PDF(PDFTemplateView):
    template_name = "iq/girls_accommodation_infoquest_pdf.html"
...
def add_students_infoquest(request):
    if request.method == 'POST':
        if 'register' in request.POST:
            ...
            return render(request, 'iq/present_student_id_number.html',
                          {
                              'student': instance
                          })
        if 'ok' in request.POST:
            return render(request, "iq/add_students_infoquest.html", {})
...
def infoquest_mark_student_presence(request):
    if request.method == 'POST':
        ...
        if 'put_id' in request.POST:
            ...
            list_of_students = Infoquest_student.objects.filter(present=False)
            return render(request, 'iq/mark_student_presence_infoquest.html',
                          {
                              'list_of_students': list_of_students
                          })
        ...
        if 'edit' in request.POST:
            got_student = request.POST.get('student')
            instance = Infoquest_student.objects.get(id=got_student)
            return render(request, 'iq/edit_information_infoquest.html',
                          {
        ...
        return render(request, 'iq/mark_student_presence_infoquest.html', {'list_of_students': list_of_students})
...
def infoquest_view_present(request):
    if request.method == 'POST':
        if 'absent_student' in request.POST:
            ...
            return render(request, 'iq/view_present_infoquest.html',
                          {
                              'list_of_students': list_of_students,
...
def infoquest_view_present_ppt(request):
    if request.method == 'POST':
        ...
        list_of_students = Infoquest_student.objects.filter(present=True, registration_type='P').order_by('-entry_time')
        return render(request, 'iq/view_present_infoquest.html', {'list_of_students': list_of_students})
...
def infoquest_edit_student(request):
    ...
    if request.method == 'POST':
        if 'update' in request.POST:
            ...
            instance.accommodation = accommodation_needed
            instance.save()
            return render(request, 'iq/edit_student_infoquest.html',
                          {
                              'list_of_students': list_of_students,
                              'student': instance
                          })
    ...
    return render(request, 'iq/edit_student_infoquest.html', {'list_of_students': list_of_students})
...
def add_infoquest_events(request):
    ...
    return render(request, 'iq/add_infoquest_events.html', {
...
def view_infoquest_events(request):
    if request.method == 'POST':
        if 'update' in request.POST:
            ...
            return render(request, 'iq/edit_infoquest_event.html', {
                'event': event
            })

    events_list = events.objects.all()
    return render(request, 'iq/view_infoquest_events.html', {
        'events_list': events_list
    })
...
def selected_students(request):
    ...
    return render(request, 'iq/selected_students.html', {
        'events_list': events_list,
...
def infoquest_query(request):
    ...
    return render(request, 'iq/infoquest_queries.html',
                  {
                      'list_of_students': list_of_students
                  })
...
def infoquest_ppt_submitted(request):
        ...
        if 'submit' in request.POST:
            ...
            for student in Infoquest_student.objects.all():
                if not ppt.objects.filter(student=student):
                    list_of_students.append(student)
            return render(request, 'iq/ppt_submitted.html',
                          {
                              'list_of_students': list_of_students,
    ...
    return render(request, 'iq/ppt_submitted.html', {'list_of_students': list_of_students})
...
def infoquest_view_ppt_submitted(request):
    if request.method == 'POST':
        if 'absent_student' in request.POST:
            ...
            return render(request, 'iq/view_ppt_submitted.html',
                          {
                              'list_of_students': list_of_students,
        ...
        return render(request, 'iq/view_ppt_submitted.html', {'list_of_students': list_of_students})
        ...
        if 'submit' in request.POST:
            ...
            for each in order_list:
                if each not in another_list:
                    ...
                    return render(request, 'iq/result_display_order.html',
                                  {
